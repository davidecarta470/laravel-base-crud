    ...
    <div class="col-6 offset-3">
      ...
      <form action="{{route('series.store')}}" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" value="{{old('img')}}" class="form-control" name="img" id="img">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" value="{{old('series')}}" class="form-control" name="series" id="series">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" value="{{old('sale_date')}}" class="form-control" name="sale_date" id="sale_date">
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Tipo</label>
          <input type="text" value="{{old('type')}}" class="form-control" name="type" id="type">
        </div>
